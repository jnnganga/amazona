	...
	return (
		<>
			<Head>
				...
				<meta name='Ecommerce website' content='Generated by create next app' />
						...
						<div>
							<Link href='/cart'>
								<a className='p-2'>
									Cart
									{cartItemsCount > 0 && (
										<span className='ml-1 rounded-full bg-red-600 px-2 py-1 text-xs font-semibold text-white'>
											{cartItemsCount}
										</span>
									)}
								</a>
